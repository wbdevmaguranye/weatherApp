  ...
  <div class="h-screen relative overflow-hidden">
    ...
    <div class="absolute w-full h-full top-0 p-48">
      ...
      <div class="mt-20">
        ...
        <button class="bg-sky-400 w-20 ml-2 text-white h-10" @click="handleClick">
          Search
        </button>
      </div>
    </div>
...
console.log("Joel Test",config.AppSecret)
...
const handleClick = () => {
  ...
  input.value = "";
  refresh();
  // console.log("testing apikey",appid )
...
const {data: city, error, refresh,} = useAsyncData("city",  async () => {
    ...
    try {
       response = await $fetch(
        ...
        params: {
          units: "metric",
          appid:"e21eab770e30b1906f450a43ebe45880",
        },
    });
    // console.log("testing apikey",appid )
      ...
      // console.log("testing apikey2",appid )
    }
    return response;
